...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__upsertionAdapterOfNote = new EntityUpsertionAdapter<Note>(new EntityInsertionAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "INSERT INTO `Note` (`title`,`description`,`id`) VALUES (?,?,nullif(?, 0))";
      }
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE `Note` SET `title` = ?,`description` = ?,`id` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object upsertNote(final Note note, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpTitle,_tmpDescription,_tmpId);
            _result.add(_item);
          }
          return _result;
        } finally {
